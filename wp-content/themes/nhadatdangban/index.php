...
<html lang="en">
  ...
  <body role="document">
    ...
    <div class="container theme-showcase" role="main">
      <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="item active">
            ...
            <img class="img-responsive" alt="Sass and Less support" src="<?php echo get_template_directory_uri(); ?>/images/7fbac-web-slide-bangkok-face-002-01.jpg">
          </div>
          <div class="item">
            ...
            <img class="img-responsive" alt="Sass and Less support" src="<?php echo get_template_directory_uri(); ?>/images/00932-web-slide-bangkok-face-003-01.jpg">
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-4">
          <img class="img-responsive" alt="Sass and Less support" src="http://getbootstrap.com/assets/img/sass-less.png">
          <h3>Preprocessors</h3>
        ...
        <div class="col-sm-4">
          <img class="img-responsive" alt="Responsive across devices" src="http://getbootstrap.com/assets/img/devices.png">
          <h3>One framework, every device.</h3>
          <p>Bootstrap easily and efficiently scales your websites and applications with a single code base, from phones to tablets to desktops with CSS media queries.</p>
        </div>
        <div class="col-sm-4">
          <img class="img-responsive" alt="Components" src="http://getbootstrap.com/assets/img/components.png">
